...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_API_URL}/api/questions/solved/count/${userId}`
      )
      .then((response) => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_API_URL}/api/bookmarks/count/${userId}`
      )
      .then((response) => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_API_URL}/api/questions/mcq-result/${userId}`
      )
      .then((response) => {
